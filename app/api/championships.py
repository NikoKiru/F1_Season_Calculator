...
def wins(conn: ConnDep, season: SeasonDep) -> dict[str, int]:
...
def min_races(conn: ConnDep, season: SeasonDep) -> dict[str, int]:
...
def get_championship(championship_id: int, conn: ConnDep) -> dict:
